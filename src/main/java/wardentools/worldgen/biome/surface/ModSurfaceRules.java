...
public class ModSurfaceRules {
    ...
    private static final SurfaceRules.RuleSource PURPLE_SOIL = makeStateRule(BlockRegistry.PURPLE_SOIL.get());
    private static final SurfaceRules.RuleSource DARKGRASS = makeStateRule(BlockRegistry.DARKGRASS_BLOCK.get());
    private static final SurfaceRules.RuleSource GRASS_PURPLE_SOIL = makeStateRule(BlockRegistry.GRASS_PURPLE_SOIL.get());
    ...
    public static SurfaceRules.RuleSource makeRules() {
        ...
        SurfaceRules.RuleSource bedrockFloor = SurfaceRules.ifTrue(SurfaceRules.verticalGradient(
        ...
        // Purple Soil surface for aurora valley
        SurfaceRules.RuleSource purpleSoilSurface = SurfaceRules.ifTrue(
                SurfaceRules.abovePreliminarySurface(),
                SurfaceRules.sequence(
                        SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR,
                                SurfaceRules.ifTrue(isAtOrAboveWaterLevel, GRASS_PURPLE_SOIL)),
                        SurfaceRules.ifTrue(SurfaceRules.ON_FLOOR, PURPLE_SOIL),
                        SurfaceRules.ifTrue(SurfaceRules.UNDER_FLOOR, PURPLE_SOIL)
                )
        );

        // Aurora valley surface
        SurfaceRules.RuleSource auroraValleySurface = SurfaceRules.sequence(
                bedrockFloor,
                purpleSoilSurface,
                abyssaliteUnderground,
                DEEPSLATE
        ...
        SurfaceRules.RuleSource abyssGeneration = SurfaceRules.sequence(
                ...
                SurfaceRules.ifTrue(SurfaceRules.isBiome(ModBiomes.AURORA_VALLEY), auroraValleySurface),

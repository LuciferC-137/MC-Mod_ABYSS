...
import wardentools.worldgen.features.tree.custom.DarktreeTrunkPlacer;
import wardentools.worldgen.features.tree.custom.DuskWillowTrunkPlacer;
import wardentools.worldgen.features.tree.custom.WhitetreeTrunkPlacer;
...
public class ModTrunkPlacerTypes {
    ...
    public static final Supplier<TrunkPlacerType<DuskWillowTrunkPlacer>> DUSK_WILLOW_TRUNK_PLACER =
            TRUNK_PLACER.register("dusk_willow_trunk_placer",
            		() -> new TrunkPlacerType<>(DuskWillowTrunkPlacer.CODEC));

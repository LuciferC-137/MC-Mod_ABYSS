...
public class ArmorRegistry {
	public static final DeferredRegister<Item> ARMORS = DeferredRegister.create(ForgeRegistries.ITEMS, ModMain.MOD_ID);
	
	public static final RegistryObject<ConfigurableDefenseItem> DEEPCRISTAL_HELMET =
			...
			() -> new ConfigurableDefenseItem(ModMaterials.DEEPCRISTAL, ArmorItem.Type.HELMET, new Item.Properties()
					...
					.stacksTo(1)
					.fireResistant()));
	public static final RegistryObject<ArmorWithEffectItem> DEEPCRISTAL_CHESTPLATE =
			...
			()->new ArmorWithEffectItem(ModMaterials.DEEPCRISTAL, ArmorItem.Type.CHESTPLATE, new Item.Properties()
					...
					.stacksTo(1)
					.fireResistant()));
	public static final RegistryObject<ConfigurableDefenseItem> DEEPCRISTAL_LEGGINGS =
			...
			()->new ConfigurableDefenseItem(ModMaterials.DEEPCRISTAL, ArmorItem.Type.LEGGINGS, new Item.Properties()
					...
					.stacksTo(1)
					.fireResistant()));
	public static final RegistryObject<ConfigurableDefenseItem> DEEPCRISTAL_BOOTS =
	...
	public static final RegistryObject<ConfigurableDefenseItem> RADIANCE_CRISTAL_HELMET =
			ARMORS.register("radiance_cristal_helmet",
					()->new ConfigurableDefenseItem(ModMaterials.RADIANCE_CRISTAL, ArmorItem.Type.HELMET, new Item.Properties()
							...
							.stacksTo(1)
							.fireResistant()));
	public static final RegistryObject<ArmorWithEffectItem> RADIANCE_CRISTAL_CHESTPLATE =
			ARMORS.register("radiance_cristal_chestplate",
					()->new ArmorWithEffectItem(ModMaterials.RADIANCE_CRISTAL, ArmorItem.Type.CHESTPLATE, new Item.Properties()
							...
							.stacksTo(1)
							.fireResistant()));
	public static final RegistryObject<ConfigurableDefenseItem> RADIANCE_CRISTAL_LEGGINGS =
			ARMORS.register("radiance_cristal_leggings",
					()->new ConfigurableDefenseItem(ModMaterials.RADIANCE_CRISTAL, ArmorItem.Type.LEGGINGS, new Item.Properties()
							...
							.stacksTo(1)
							.fireResistant()));
	public static final RegistryObject<ConfigurableDefenseItem> RADIANCE_CRISTAL_BOOTS =

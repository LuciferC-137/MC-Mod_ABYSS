...
public enum RadianceCristalMaterial implements ArmorMaterial {
	RADIANCE_CRISTAL_MATERIAL("radiance_cristal",  37, new int[]{3, 6, 8, 3}, 25,
    ...
    RadianceCristalMaterial(String name, int durability, int[] protection, int enchantability,

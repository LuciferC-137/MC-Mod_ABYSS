...
public class PaleWanderer extends HierarchicalModel<PaleWandererEntity> {
	...
	@Override
	public void setupAnim(PaleWandererEntity entity, float limbSwing,
			float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		root().getAllParts().forEach(ModelPart::resetPose);
		animate(entity.calmAnimationState, PaleWandererAnimation.sit, ageInTicks);

		animateWalk(PaleWandererAnimation.walking, limbSwing, limbSwingAmount, 1f, 2.5f);

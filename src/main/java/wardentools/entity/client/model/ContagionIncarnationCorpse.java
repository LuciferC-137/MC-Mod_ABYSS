...
public class ContagionIncarnationCorpse extends EntityModel<ContagionIncarnationCorpseRenderState> {
	public static final ModelLayerLocation LAYER_LOCATION
			= new ModelLayerLocation(
					ResourceLocation.fromNamespaceAndPath(ModMain.MOD_ID, "contagion_incarnation_corpse"), "main");
	...
	public ContagionIncarnationCorpse(ModelPart root) {
		super(root);
	...
	@Override
	public void setupAnim(@NotNull ContagionIncarnationCorpseRenderState state) {

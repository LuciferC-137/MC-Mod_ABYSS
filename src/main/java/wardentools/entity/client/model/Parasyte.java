...
public class Parasyte extends EntityModel<ParasyteRenderState> {
	...
	@Override
	public void setupAnim(@NotNull ParasyteRenderState state) {
		root().getAllParts().forEach(ModelPart::resetPose);
		animate(state.idleAnimation, ParasyteAnimation.idle, state.ageInTicks);
		animateWalk(ParasyteAnimation.crawl, state.walkAnimationPos,

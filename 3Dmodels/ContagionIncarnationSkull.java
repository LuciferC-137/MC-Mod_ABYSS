...
public class ContagionIncarnationSkull<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "contagionincarnationskull"), "main");
	private final ModelPart bb_main;

	public ContagionIncarnationSkull(ModelPart root) {
